...
export const metadata: Metadata = {
  ...
  description:
    "Toute œuvre certifiée reçoit son Sceau. Trois gestes suffisent : enrôlement biométrique, dépôt de l'œuvre, apposition du Sceau. Physique ou numérique, ancien ou contemporain.",
};
...
const ETAPES: { titre: string; texte: string }[] = [
  {
    ...
    texte:
      "Enrôlement biométrique multimodal — iris, morphologie, voix, paume, pouls. Ces empreintes ne quittent jamais votre appareil. Seule leur dérivation cryptographique parvient à la plateforme.",
  },
  {
    titre: "L'œuvre est déposée",
    texte:
      "Photographie haute définition pour une toile, fichier natif pour une œuvre numérique, scan pour une sculpture. La plateforme consigne dimensions, technique, date, histoire — tout ce qui la rend unique.",
  },
  {
    titre: "Le Sceau s'appose",
    texte:
      "Le Sceau apparaît et devient l'identité inaltérable de l'œuvre. La plaque compagnon numérotée est générée. L'inscription au Registre public est instantanée et à vie.",
  },
];
...
export default function CertifierPage() {
  return (
    <main>
      {/* ═══════════════════════════════════════════════════════════
          1. HERO — image + titre sur une ligne + AppStoreBadges
          ═══════════════════════════════════════════════════════════ */}
      ...
      {/* ═══════════════════════════════════════════════════════════
          2. SALLE DE CERTIFICATION — anthracite + timeline
          ═══════════════════════════════════════════════════════════ */}
      ...
      {/* ═══════════════════════════════════════════════════════════
          3. CONNEXION / INSCRIPTION — bandeau noir
          ═══════════════════════════════════════════════════════════ */}
      <section
