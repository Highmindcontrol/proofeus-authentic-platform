...
export const metadata: Metadata = {
  ...
  description:
    "Certaines choses traversent le temps. Le Coffre est la salle où la Maison conserve la mémoire — un registre immuable, ouvert au public, qui survit aux modes et aux régimes.",
};
      ...
      sections={[
        {
          ...
          corps:
            "Une œuvre traverse les siècles. Les documents qui l'accompagnent, non. Les certificats papier jaunissent, se perdent, se falsifient. Les archives brûlent. Les héritiers meurent. La Maison a été conçue pour survivre à tous ces oublis — parce que sa mémoire n'appartient à personne en particulier, et donc à chacun.",
        },
        {
          titre: "Un registre ouvert, inaltérable, souverain",
          corps:
            "Chaque Sceau émis par la Maison est inscrit dans un registre public. Toute personne au monde peut consulter l'existence d'une œuvre certifiée, son auteur, sa date d'entrée dans la Maison. Nul ne peut effacer une entrée du registre. Nul ne peut la falsifier. La Maison elle-même n'en a pas le pouvoir.",
        },
        {
          titre: "Ce qui traverse le temps",
          corps:
            "Le Sceau, la plaque compagnon, l'iris de l'auteur, l'empreinte cryptographique de l'œuvre — tous demeurent quand l'artiste s'en va, quand la galerie ferme, quand la Maison elle-même ne serait plus. Le registre est notre engagement solennel : ce que nous scellons aujourd'hui doit pouvoir être vérifié dans un siècle.",
        },
      ]}
      cta={[
