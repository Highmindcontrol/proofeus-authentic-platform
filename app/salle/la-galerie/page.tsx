      ...
      sections={[
        {
          ...
          corps:
            "Le marché de l'art repose sur une convention silencieuse : ce qui est authentifié peut être valorisé. Une œuvre dont l'auteur ne peut être confirmé perd son socle — quelle que soit sa beauté. La Maison reconnaît ce fait ancien et lui donne, à l'ère post-IA, un outil à la hauteur du problème.",
        },
        {
